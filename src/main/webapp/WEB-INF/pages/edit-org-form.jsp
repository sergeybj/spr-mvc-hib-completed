...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="body">
		<div class="container">
			...
			<h3><fmt:message key="edit.org.page" bundle="${language}"/></h3>
			<p><fmt:message key="edit.org.page.text" bundle="${language}"/></p>
				<p>${message}</p>
				<div class="form-group">
					<label for="usr"><fmt:message key="edit.org.page.name" bundle="${language}"/></label>
